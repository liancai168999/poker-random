...
public class IDCard {
     ...
     * 中国公民身份证号码不包括最后一位长度。
     */
    public static final int CHINA_ID_LENGTH = 17;
    ...
    public static Map<String, String> cityCodes = new HashMap<>(36);

    /**
     * 台湾身份首字母对应数字
     */
    public static Map<String, Integer> twFirstCode = new HashMap<>(26);

    /**
     * 香港身份首字母对应数字
     */
    public static Map<String, Integer> hkFirstCode = new HashMap<>(16);
    ...
    public static void main(String[] args) {
        System.out.println(getProvinceByIdCard("440804198911112864"));
    }
    ...
    private static String getVerify(String eightcardid) {
        int remaining = 0;
        if (eightcardid.length() == CHINA_ID_MAX_LENGTH) {
            eightcardid = eightcardid.substring(0, 17);
        }

        int[] ai = new int[18];
        if (eightcardid.length() == CHINA_ID_LENGTH) {
            int sum = 0;
            for (int i = 0; i < CHINA_ID_LENGTH; ++i) {
