...
public class AesEncryptUtils {
     ...
     * @return
     */
    private static SecretKeySpec getSecretKey(final String encryptKey) throws TokenException {
        ...
        try {
            ...
            throw new TokenException(ResultStatusEnum.ERROR_AES_Key_CONVE.name());
        }
    }

    public static byte[] aesEncryptToBytes(String content, String encryptKey) throws TokenException {
        ...
        try {
            ...
            throw new TokenException(ResultStatusEnum.ERROR_AES_Key_ENCRYPT.name());
        }
    }
    ...
    public static String aesDecryptByBytes(byte[] encryptBytes, String decryptKey) throws TokenException {
        try {
            Cipher cipher = Cipher.getInstance(DEFAULT_CIPHER_ALGORITHM);
            ...
            throw new TokenException(ResultStatusEnum.ERROR_AES_Key_DECRYPT.name());
        }
    }
